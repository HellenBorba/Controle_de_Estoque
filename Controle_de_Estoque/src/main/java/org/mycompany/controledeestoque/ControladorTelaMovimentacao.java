...
public class ControladorTelaMovimentacao {
    ...
    @FXML
    private Button btnAbrirCadastroMovimentacao;

    @FXML
    public void initialize() {
        btnAbrirCadastroMovimentacao.setOnMouseClicked(event -> abrirCadastroMovimentacao());
        ...
        btnAbrirCadastroMovimentacao.setStyle(
    ...
    // Carregar o arquivo FXML que vai sobrepor a tela atual
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/telas/RelatorioMovimentacao.fxml"));
...
// Criar uma nova janela (Stage) para sobrepor a tela atual
        ...
        novaJanela.setTitle("Relatório de movimentação");
        novaJanela.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void carregarTela(String fxmlFile) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/telas/" + fxmlFile));
    ...
    public void abrirCadastroMovimentacao(){
        try {
        // Carregar o arquivo FXML que vai sobrepor a tela atual
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/telas/CadastroMovimentacao.fxml"));
        Parent novaTela = loader.load();

// Criar uma nova janela (Stage) para sobrepor a tela atual
        Stage novaJanela = new Stage();
        novaJanela.setScene(new Scene(novaTela));
        novaJanela.initOwner(btnAbrirCadastroMovimentacao.getScene().getWindow()); // Define a janela principal como dona
        novaJanela.initModality(Modality.APPLICATION_MODAL); // Define como uma janela modal, bloqueando interações com a janela principal
