...
public class ControladorTelaProduto {
    ...
    public void abrirRelatorio() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/telas/RelatorioProduto.fxml"));
...
// Criar uma nova janela (Stage) para sobrepor a tela atual
    ...
    public void abrirCadastroProduto(){
        try {
        // Carregar o arquivo FXML que vai sobrepor a tela atual
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/telas/CadastroProduto.fxml"));
        Parent novaTela = loader.load();
