...
public class ControladorTelaCategoria {
    ...
    @FXML
    private Button btnAbrirCadastroCategoria;

    @FXML
    public void initialize() {
        btnAbrirCadastroCategoria.setOnMouseClicked(event -> abrirCadastroCategoria());
        ...
        btnAbrirCadastroCategoria.setStyle(
    ...
    public void abrirRelatorio() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/telas/RelatorioCategoria.fxml"));
...
// Criar uma nova janela (Stage) para sobrepor a tela atual
        ...
        novaJanela.setTitle("Relatório de categoria");
        novaJanela.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void abrirCadastroCategoria(){
        try {
        // Carregar o arquivo FXML que vai sobrepor a tela atual
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/telas/CadastroCategoria.fxml"));
        Parent novaTela = loader.load();

// Criar uma nova janela (Stage) para sobrepor a tela atual
        Stage novaJanela = new Stage();
        novaJanela.setScene(new Scene(novaTela));
        novaJanela.initOwner(btnAbrirCadastroCategoria.getScene().getWindow()); // Define a janela principal como dona
        novaJanela.initModality(Modality.APPLICATION_MODAL); // Define como uma janela modal, bloqueando interações com a janela principal
        novaJanela.setTitle("Cadastro de categoria");
        novaJanela.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
